...
{
   for (int r = 0; r < (int)input_string.length(); r++)
   {
   ...
   int count=0;
   for (int s=0; s < (int)input_string.length(); s++)
   {
       for(int z=0; z < (int)array.length(); z++)
       {
   ...
   if (count == (int)input_string.length())
   {
     return true;
   }
   else
